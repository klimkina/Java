...
public class Solution {
	public static class Fraction {
		...
		private static void makeCoef(int power){
		...
		public static double count(int power,double v){
			double r=0;
    	...
    	if(n < 3)
    		return 0;
    	makeCoef(k);
    	return ((int)(count(k, n-1) - 1)) % 1000000009;
    }

    public static void main(String[] args) {
    	int result = highwayConstruction(5, 3); //520247713 
    	System.out.println(result);
    	result = highwayConstruction(1000000009, 1000); //1000000008 
    	System.out.println(result);
    	result = highwayConstruction(10000000000000000L, 400); //881626203 
    	System.out.println(result);
    }
}