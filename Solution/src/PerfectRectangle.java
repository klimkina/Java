...
public class PerfectRectangle {
	public boolean isRectangleCover(int[][] rectangles) {
        ...
        if (!set.contains(x1 + " " + y1) || !set.contains(x1 + " " + y2) 
        		|| !set.contains(x2 + " " + y1) || !set.contains(x2 + " " + y2) || set.size() != 4) return false;
	...
	public static void main(String[] args) {
		...
		int[][] rectangles1 = 
				{{0,0,4,1},{7,0,8,2},{6,2,8,3},{5,1,6,3},{4,0,5,1},{6,0,7,2},
						{4,2,5,3},{2,1,4,3},{0,1,2,2},{0,2,2,3},{4,1,5,2},{5,0,6,1}};
		int[][] rectangles2 = {{1,1,2,3},
		                      {1,3,2,4},
		                      {3,1,4,2},
		                      {3,2,4,4}};
		int[][] rectangles3 = {{1,1,3,3},
		                      ...
		                      {1,3,2,4},
		                      {3,2,4,4}};
		int[][] rectangles4 = {{1,1,3,3},
		                      {3,1,4,2},
		                      {1,3,2,4},
		                      {2,2,4,4}};
		PerfectRectangle obj = new PerfectRectangle();
		System.out.println(obj.isRectangleCover(rectangles1));
		/*System.out.println(obj.isRectangleCover(rectangles2));
		System.out.println(obj.isRectangleCover(rectangles3));
		System.out.println(obj.isRectangleCover(rectangles4));*/
	}
